...
foreach($suite in @('tests/test-codex.ps1','tests/test-dashboard.ps1','tests/test-audit-codex.ps1','tests/test-safety.ps1','tests/test-lifecycle.ps1','tests/test-onboarding.ps1')){
