...
# than a serial one.
$work=@()
$work+=[pscustomobject]@{name='tests/test-central-owner.ps1';weight=1;executable=$ps;arguments=@('-NoProfile','-ExecutionPolicy','Bypass','-File',(Join-Path $root 'tests/test-central-owner.ps1'))}
