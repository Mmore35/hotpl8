...
# than a serial one.
$work=@()
foreach($suite in @(@('tests/test-codex.ps1',70),@('tests/test-dashboard.ps1',27),@('tests/test-overview.ps1',7),@('tests/test-capacity.ps1',13),@('tests/test-claude-plans.ps1',1),@('tests/test-audit-codex.ps1',1),@('tests/test-safety.ps1',18),@('tests/test-lifecycle.ps1',25),@('tests/test-onboarding.ps1',10),@('tests/test-operations.ps1',3),@('tests/test-tray.ps1',2),@('tests/test-agent-api.ps1',6),@('tests/test-leases.ps1',4),@('tests/test-mcp.ps1',4),@('tests/test-t3-routing.ps1',15))){
