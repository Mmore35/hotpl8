...
- Run the offline suites concurrently, longest first, so a full verification takes under half the wall time; `scripts/test.ps1 -Parallel 1` still runs them one at a time.
